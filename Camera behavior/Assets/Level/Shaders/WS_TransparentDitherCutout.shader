...
// NOTE the render queue should be set to Transparent (3000) if this shader is used in association with a normal dither shader
Shader "Effects/TransparentDitherCutoff" {
    ...
    Properties {
        ...
        _AlphaTestRef("Alpha Cutoff",  Range(0.0, 1.0)) = 0.5
    }
    ...
    SubShader {
        ...
        void surf(Input IN, inout SurfaceOutputStandard o)
        {
            ...
            // apply cutout
            if (o.Alpha < _AlphaTestRef)
            {
                clip(o.Alpha - _AlphaTestRef);
                return;
            }
