...
/**
* Provides the progressbar position edit controller
*@author Jean-Milost Reymond
*/
public class CS_ProgressPosEditController : MonoBehaviour
{
    ...
    */
    ...
    {
        m_CurveController.m_ProgressBarPos = float.Parse(m_Edit.text);
    }
}
