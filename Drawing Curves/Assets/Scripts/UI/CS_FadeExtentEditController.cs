...
/**
* Provides the fade extent factor edit controller
*@author Jean-Milost Reymond
*/
public class CS_FadeExtentEditController : MonoBehaviour
{
    ...
    */
    ...
    {
        m_CurveController.m_FadeExtentFactor = float.Parse(m_Edit.text);
    }
}
